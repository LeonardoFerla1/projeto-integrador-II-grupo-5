...
Chart.js (v4.4.1): Biblioteca utilizada para renderizar os gráficos interativos em elementos <canvas>.
PapaParse (v5.4.1): Extensão utilizada para converter o ficheiro CSV diretamente em objetos JavaScript estruturados.
